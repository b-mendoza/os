/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bcadcd96e05c48390599368719c4a0e9)
...
declare namespace Cloudflare {
	interface Env {
		...
		AZURE_AI_REGION: string;
		AZURE_AI_RESOURCE_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AZURE_AI_API_KEY" | "AZURE_AI_REGION" | "AZURE_AI_RESOURCE_ID" | "CLOUDFLARE_AI_GATEWAY_URL" | "OPENROUTER_API_KEY" | "STORAGE_ACCESS_KEY_ID" | "STORAGE_BUCKET" | "STORAGE_ENDPOINT" | "STORAGE_REGION" | "STORAGE_SECRET_ACCESS_KEY">> {}
}
